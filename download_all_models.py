...
MODELS = [
    {
        "name": "HAT-GAN Sharper (Flagship State-of-the-Art Transformer)",
    ...
    {
        "name": "HAT ImageNet Pretrain (Faithful Restoration)",
    ...
    {
        "name": "RealESRGAN x4plus (Legacy Photo Backup)",
    ...
    {
        "name": "GFPGAN v1.4 (Face Restoration Shield)",
        "file": "GFPGANv1.4.pth",
